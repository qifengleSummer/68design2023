    ...
    <div className='login-container'>
      ...
      <Form
          ...
          <Form.Item {...tailLayout} >
              <p>
                登录即同意  <Link className='link-style' to="https://www.baidu.com">注册协议</Link>、<Link className='link-style' to="https://www.baidu.com">交易服务协议</Link>
              </p>
          </Form.Item>
          <Form.Item {...tailLayout}>
              ...
              <p>
                  <Link className='link-style' to="/register">立即注册</Link>
                  <Link className='link-style' to="/forget-pwd">忘记密码</Link>
              </p>
          </Form.Item>
      </Form>
    </div>
...
const PwdForm = () => {
  return (
    <div>
      <Form.Item name="phoneNo" label="用户名" rules={[{ required: true, message: '请输入用户名/Email/手机号' }]}>
